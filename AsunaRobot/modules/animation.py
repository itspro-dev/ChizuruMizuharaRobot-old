...
#sleep how many times after each edit in 'loveu' 
EDIT_SLEEP = 1
#edit how many times in 'loveu' 
EDIT_TIMES = 34
...
wnames_show = [
			...
			"Ħḯƞåƭå Ħƴʋɠå",
			"Ƴòɍʋḯƈħḯ Ṥħḯħòʋḯƞ",
			"Ƚåṥƭ Òƞẻ ḯƶ ☀️Ƈħḯƶʋɍʋ Ṁḯƶʋħåɍå☀️😄🖤",
]
...
@user_admin
@run_async
def loveu(update: Update, context: CallbackContext):
    bot, args = context.bot, context.args
    msg = update.effective_message.reply_text('❣️') 
    for x in range(EDIT_TIMES):
        msg.edit_text(loveu_you[x%34])
        time.sleep(EDIT_SLEEP)
