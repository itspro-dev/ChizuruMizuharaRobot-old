...
from AsunaRobot.function.inlinehelper import arq
from AsunaRobot.function.pluginhelpers import get_text, progress
...
async def ytmusic(client, message: Message):
    ...
    if dl_limit >= 4:
        await message.reply_text(
            "Chizuru's server busy due to too many downloads, try again after sometime."
        )
        return
