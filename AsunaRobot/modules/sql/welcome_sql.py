...
DEFAULT_WELCOME_MESSAGES = [
    "Ugh, {first} I have a problem ... I can't stop thinking about you.",
    "I'm trying on these new bras, but I need a second opinion. Care to share your thoughts?",
    "Just FYI, your voice sends chills throughout my entire body.",
    "Just got out of the shower. Want to help me dry off?",
    "Can I have you for breakfast in bed?",
    "I smile whenever I get a message from you {first} <3",
    "Thank you for reminding me what butterflies feel like.",
    "I'm in my bed, you're in your bed ... One of us is in the wrong place.",
    "Let's FaceTime tonight. {first} I promise you won't regret it ;)",
    "My phone is in my hands, but {first} I would rather be holding you.",
    "Why do I always think of you {first} when I'm trying to concentrate ... Grrr, hate you so much right now!",
    "I've been thinking about you {first} ... and it hasn't all been PG.",
    " {first} You look so good in that new post on Instagram!",
    "Hey, {first} cutia. Haven't talked to you in a while. Thought I'd say hello!",
    "I always wake up smiling. I think it's your fault {first} .",
    "Aside from pizza, I crave you most.",
    "Just watched Thor. Chris Hemsworth is hot, but I wish I'd been watching you instead.",
    " {first} You’re the most masculine guy I've ever met.",
    "Hey darling {first} do you want to go drink with me?",
    "Just went camping. Come over and give me a tick check?",
    "I Really Like you {first} ",
    "So {first} when are you taking me on a date?",
    " {first} My back hurts. Want to come over and massage it?",
    "Let me read you a poem under the full moon tonight.",
    "What's up, buttercup?",
    "What are you doing tomorrow other than working up the courage to finally ask me out?",
    "Buy me a drink.",
    "Want to kiss you so bad.",
    "Let me buy you a drink.",
    "Come warm me up. It's freezing outside.",
    "You're as hot as I am cold ;).",
    "Thinking of you today.",
    "Good morning , {first} handsome. Have a great day!",
    "{first} is here!",  # Discord welcome messages copied
    "Ready player {first}",
    "Kazuya, {first} is here.",
